    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false" style="overflow: hidden;">
          ...
          <li class="nav-item">
            <a href="user-forums.php?project_id=<?php echo $pid; ?>&member_id=<?php echo $mid ?>" class="nav-link active">
          ...
          <li class="nav-item">
            <a href="/arcmeridians/modules/user/user-finalised-designs.php?project_id=<?php echo $pid; ?>&member_id=<?php echo $mid ?>" class="nav-link">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col">
            <h1 class="m-0 text-dark text-center">General Discussions</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
