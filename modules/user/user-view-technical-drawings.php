  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col">
          	<a href="/arcmeridians/modules/user/user-technical-drawings.php?project_id=<?php echo $pid; ?>&member_id=<?php echo $mid ?>" class="btn btn-info">
    ...
    <?php 
        if (isset($_GET['view'])) {
            $imgid=$_GET['view'];
            $view = mysqli_query($conn, "SELECT technical_title,technical_description,technical_images FROM technical_drawings WHERE project_id=$pid AND img_id=$imgid");
                  ...
                  $ext= pathinfo($dimage, PATHINFO_EXTENSION);
                    echo "<div class='container-fluid'>
                        ...
                        <div class='card text-center'>
                                ...
                                echo "<img style='overflow: auto; max-height: 600px;' class='img-fluid' src='/arcmeridians/modules/admin/technicalimages/".$dimage."'>";
                                  }
