...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="include/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">Arcmeridians</span>
    </a>
  ...
  <footer class="main-footer">
    <strong>Arcmeridians &copy; 2020.</strong> All rights reserved.
  </footer>
</div>
<!-- ./wrapper -->
